export declare const listStyles: import("@stitches/core/types/styled-component").CssComponent<never, {}, {
    sm: string;
    md: string;
    lg: string;
    xl: string;
...
export declare const listIconStyles: import("@stitches/core/types/styled-component").CssComponent<never, {}, {
    sm: string;
    md: string;
    lg: string;
    xl: string;
