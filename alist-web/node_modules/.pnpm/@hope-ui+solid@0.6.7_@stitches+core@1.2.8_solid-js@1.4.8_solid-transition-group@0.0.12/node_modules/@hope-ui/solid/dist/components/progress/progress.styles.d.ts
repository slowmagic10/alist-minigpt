...
export declare const progressStyles: import("@stitches/core/types/styled-component").CssComponent<never, {
...
export declare type ProgressVariants = VariantProps<typeof progressStyles>;
export declare const progressIndicatorStyles: import("@stitches/core/types/styled-component").CssComponent<never, {
...
export declare type ProgressIndicatorVariants = VariantProps<typeof progressIndicatorStyles>;
export declare const progressLabelStyles: import("@stitches/core/types/styled-component").CssComponent<never, {}, {
    sm: string;
    md: string;
    lg: string;
    xl: string;
