...
export declare const closeButtonStyles: import("@stitches/core/types/styled-component").CssComponent<never, {
...
export declare type CloseButtonVariants = VariantProps<typeof closeButtonStyles>;
