...
export declare const containerStyles: import("@stitches/core/types/styled-component").CssComponent<never, {
    centered?: boolean | "true" | undefined;
    centerContent?: boolean | "true" | undefined;
}, {
    sm: string;
    md: string;
    lg: string;
...
export declare type ContainerVariants = VariantProps<typeof containerStyles>;
