export declare const tooltipTransitionName: {
    scale: string;
};
export declare const tooltipTransitionStyles: () => string;
export declare const tooltipStyles: import("@stitches/core/types/styled-component").CssComponent<never, {}, {
    sm: string;
    md: string;
    lg: string;
    xl: string;
...
export declare const tooltipArrowStyles: import("@stitches/core/types/styled-component").CssComponent<never, {}, {
    sm: string;
    md: string;
    lg: string;
    xl: string;
