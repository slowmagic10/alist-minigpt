...
class Chat:
    ...
    '''def upload_img(self, image_path, conv, img_list):
        # 创建WebDAV客户端
        options = {
        ...
        client.download(image_path, temp_file)
    ...
    ''' def alist_img(self, image_path, conv, img_list):
        # 创建WebDAV客户端
        options = {
            'webdav_hostname': 'http://localhost:5244/dav',
            'webdav_login':    'admin',
        ...
        # 下载图片到临时文件
        temp_file = './temp_image.jpg'
        client.download_sync(remote_path=image_path, local_path=temp_file)
